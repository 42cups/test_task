...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Person.siuth'
        raise RuntimeError("Cannot reverse this migration. 'Person.siuth' and its values cannot be restored.")
